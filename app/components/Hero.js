...
const Hero = () => {
  return (
    <section id="home" className='my-21'>
        ...
        <div className="relative z-20 h-full">
          <div className="absolute bottom-10 left-12.5 bg-black/20 backdrop-blur-[1px] px-6 py-4 rounded-md w-fit shadow-md">
            <div className="text-white text-3xl drop-shadow-md mb-2">
              ٱلسَّلَامُ عَلَيْكُمْ, I'm <span class="text-[#bfaeff] font-bold">Uzaib</span>
            </div>
            <div className="text-white text-base mb-4 drop-shadow-sm leading-relaxed h-20 w-75 overflow-hidden"
              ...
              Well I am an Artist working to<br></br>
                make world a better place<br></br>
                  <span className="font-semibold">Know more about me below. ⬇️</span>
                </div>
                <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                  <button onclick="downloadCV()"
                    class="bg-[#793fff] hover:bg-[#6b2fff] text-white px-8 py-3 rounded-lg shadow-lg shadow-[#793fff]/30 transition-all duration-300 transform hover:scale-105 font-medium">
